...
def start_monkey():
    ...
    cmd1 = f"adb -s {device} shell monkey -p {package} -v -v -v --throttle 10 -s {number} --ignore-crashes --ignore-timeouts --ignore-native-crashes --pct-syskeys 0 --pct-anyevent 0 8000000 > log/monkeylog.txt"
